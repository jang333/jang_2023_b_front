/*
    ...
    함수
        ...
        -종류
            ...
            3. 매개변수x 리턴O
                fuction 함수(){ return 3+3;}
            4. 매개변수x 리턴x
                fuction 함수( ){ }
        
        - 함수를 사용하면 좋은점.
            1. 반복되는 코드를 한번에 정의하고 필요에 따라 호출해서 반복 작업을 피할 수 있다. [코드 양을 줄일 수 있다.]
            2. 긴 프로그램을 기능별로 나눠 여러 함수로 나눠 작성하면 모듈화[조각/쪼개서 단위]로 전체 코드의 가독성[읽고 관리가]이 좋다.
            3. 기능별(함수별)로 수정이 가능하므로 유지보수가 쉽다.
        

        - 1. 익명함수 : 이름이 없는 함수
            - function( ){ }        : 함수의 이름이 없어서 함수호출이 불가능.
            - 익명함수를 변수/상수에 넣으면 변수/상수 호출 시 함수 실행
